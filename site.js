...
function Hero() {
  ...
  }, "Proven delivery.", /*#__PURE__*/React.createElement("br", null), "Your critical friend."), /*#__PURE__*/React.createElement("p", {
...
function ValueProp() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "vp__text"
  }, "SMA Consulting is the ", /*#__PURE__*/React.createElement("strong", null, "unified delivery force"), " for our clients. We combine deep institutional governance, board-level strategic advisory and rigorous operational standards \u2014 bridging the gap from startup to enterprise, building capability at every level.")));
}
...
/* ================= IMPACT ================= */
const CATS = ["All", "Strategy", "Technical", "Operational", "Leadership", "Enterprise"];
function Impact() {
